<template>
    <div class="islamic">
        ...
        <ul>
            <li class="add"><router-link class="ass"  to="/add-item-islamic"><span>add</span></router-link></li>
        </ul>
...
//import {storage} from '@/firebase/fire_all';
    ...
    export default {
        ...
        storgColection(){
            return { kids: db.collection('islamic')};
        },
        ...
        methods:{
            ...
            onSubmit(){
                ...
                db.collection('islamic').add(this.informitions,).then(() => {
            ...
            addImg(i){
                ...
                var storageRef = fb.storage().ref('islamic/'+file.name);
            ...
            change(change){
                router.push({name:'changeislamic', params: {id:change}})
            },

            delet (id) {

            db.collection("islamic").doc(id).delete().then(() => {
